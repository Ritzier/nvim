...
_G.packer_plugins = {
  ...
  fanyi = {
    loaded = true,
    path = "/home/ritzier/.local/share/nvim/site/pack/packer/start/fanyi",
  ...
  ["lsp_lines.nvim"] = {
    loaded = true,
    path = "/home/ritzier/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["vim-translator"] = {
    loaded = true,
    path = "/home/ritzier/.local/share/nvim/site/pack/packer/start/vim-translator",
